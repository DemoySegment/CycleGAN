...
## 创建生成器，判别器对象
G_AB = GeneratorUNet(input_shape[0], input_shape[0])
G_BA = GeneratorUNet(input_shape[0], input_shape[0])
...
def test():
    ...
    parser.add_argument('--generator_A2B', type=str, default='save/facades/G_AB_4.pth',
                        help='A2B generator checkpoint file')
    parser.add_argument('--generator_B2A', type=str, default='save/facades/G_BA_4.pth',
